#!/usr/bin/env python3
"""
FinBank - Cliente Demo para Xcapit Privacy Platform
====================================================
Aplicación que simula un banco compartiendo datos de riesgo crediticio
...
def simulate_fhe_encryption(df):
    ...
    with Progress(
        ...
        console.print("  📁 Clave pública: [green]pk_finbank_2024.key[/green]")
        console.print("  📁 Clave privada: [red]sk_finbank_2024.key (NUNCA compartir)[/red]")
    ...
    with Live(console=console, refresh_per_second=4) as live:
        for i in range(10):
            ...
            for name, status in members:
                if name == "FinBank Corp":
                    table.add_row(name, "[green]Completado ✅[/green]")
                elif i < 5:
                    table.add_row(name, "[yellow]Pendiente...[/yellow]")
                else:
                    table.add_row(name, "[green]Completado ✅[/green]")

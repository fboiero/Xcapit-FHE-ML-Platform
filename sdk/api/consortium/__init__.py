...
class ConsortiumManager:
    ...
    def create_consortium(
        ...
        return self._core.create_consortium(
            name, description, owner_id, model_type, model_config, metadata, created_by
        )
    ...
    def create_invitation(
        ...
        return self._core.create_invitation(
            consortium_id, invited_by, invite_email, role, expires_in_days
        )
    ...
    def record_data_contribution(
        ...
        return self._core.record_data_contribution(
            consortium_id,
            company_id,
            encrypted_blob_path,
            record_count,
    ...
    def add_data_contribution(
        ...
        return self._core.add_data_contribution(
            consortium_id,
            company_id,
            contribution_id,
            record_count,
    ...
    def update_member_data_status(
        ...
        return self._core.update_member_data_status(
            consortium_id, company_id, data_uploaded, record_count
        )
    ...
    def record_contribution_proof(
        ...
        return self._governance.record_contribution_proof(
            consortium_id, company_id, record_count, feature_count, data_hash, checksum
        )
    ...
    def create_proposal(
        ...
        return self._governance.create_proposal(
            consortium_id, proposer_id, proposal_type, title, description, data, voting_duration
        )
    ...
    def record_audit_event(
        ...
        return self._governance.record_audit_event(
            consortium_id, event_type, actor_id, target_id, target_type, data
        )
    ...
    def record_reward_distribution(
        ...
        return self._governance.record_reward_distribution(
            consortium_id, total_amount, distributions
        )
    ...
    def enable_compliance_framework(
        self, consortium_id: str, framework_id: str, settings: Optional[dict] = None
    ) -> dict:
    ...
    def record_compliance_check(
        ...
        return self._compliance.record_compliance_check(
            consortium_id, framework_id, control_id, status, result, evidence, checked_by, notes
        )
    ...
    def create_attestation(
        ...
        return self._compliance.create_attestation(
            consortium_id,
            framework_id,
            attested_by,
            statement,
    ...
    def record_data_processing(
        ...
        **kwargs,
        ...
        return self._compliance.record_data_processing(
            consortium_id, company_id, processing_purpose, data_categories, legal_basis, **kwargs
        )
    ...
    def set_quality_rule(
        ...
        return self._data_quality.set_quality_rule(
            consortium_id, rule_name, rule_type, threshold_min, threshold_max, weight
        )
    ...
    def get_quality_alerts(
        ...
        return self._data_quality.get_quality_alerts(
            consortium_id, company_id, severity, acknowledged, limit
        )
    ...
    def get_marketplace_models(
        ...
        return self._marketplace.get_marketplace_models(
            industry, model_type, featured_only, search, sort_by, limit
        )
    ...
    def deploy_marketplace_model(
        ...
        return self._marketplace.deploy_marketplace_model(
            model_id, consortium_id, deployed_by, config
        )
    ...
    def add_model_review(
        ...
        return self._marketplace.add_model_review(
            model_id, reviewer_id, rating, title, comment, consortium_id
        )
    ...
    def create_sandbox(
        ...
        return self._sandbox.create_sandbox(
            name, owner_id, description, template_id, industry, expires_days
        )
    ...
    def generate_synthetic_dataset(
        ...
        return self._sandbox.generate_synthetic_dataset(
            sandbox_id, name, dataset_type, created_by, record_count, description, config
        )
    ...
    def create_experiment(
        ...
        return self._sandbox.create_experiment(
            sandbox_id,
            name,
            experiment_type,
            created_by,
    ...
    def create_inference_endpoint(
        self, consortium_id: str, company_id: str, name: str, **kwargs
    ) -> dict:
    ...
    def submit_inference_request(
        self, endpoint_id: str, requester_id: str, input_data: Any, **kwargs
    ) -> dict:
        return self._federated.submit_inference_request(
            endpoint_id, requester_id, input_data, **kwargs
        )
    ...
    def create_federated_model(
        self, consortium_id: str, name: str, model_type: str, **kwargs
    ) -> dict:
    ...
    def list_federated_models(
        self, consortium_id: Optional[str] = None, status: Optional[str] = None
    ) -> list[dict]:
    ...
    def get_federated_stats(
        self, company_id: Optional[str] = None, consortium_id: Optional[str] = None
    ) -> dict:
    ...
    def request_explanation(
        self, consortium_id: str, requester_id: str, explanation_type: str, **kwargs
    ) -> dict:
        return self._explainability.request_explanation(
            consortium_id, requester_id, explanation_type, **kwargs
        )
    ...
    def list_explanations(
        ...
        return self._explainability.list_explanations(
            consortium_id, requester_id, explanation_type, limit
        )
    ...
    def add_model_to_ensemble(
        ...
        return self._ensemble.add_model_to_ensemble(
            ensemble_id, model_id, consortium_id, model_type, weight
        )
    ...
    def predict_with_ensemble(self, ensemble_id: str, requester_id: str, input_data: Any) -> dict:
